...
# Comma separated list of bundle identifiers of the apps you want these scripts to monitor. If this is not set it will monitor all apps for your team. Required
